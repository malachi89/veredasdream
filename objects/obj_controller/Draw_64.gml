...
var _text_h = 135; // Altura ajustada para el nuevo espaciado
...
draw_text_transformed_color(_rx + 1, _ry + 55 + 1, _date_text, 2.0, 2.0, 0, c_black, c_black, c_black, c_black, 0.5);
// Texto de la fecha
draw_text_transformed_color(_rx, _ry + 55, _date_text, 2.0, 2.0, 0, c_white, c_white, c_white, c_white, 1.0);

// Texto del dinero (MXN$)
draw_text_transformed_color(_rx + 1, _ry + 95 + 1, _money_text, 2.0, 2.0, 0, c_black, c_black, c_black, c_black, 0.5);
